package com.cred0.picturebackend.service.impl;
...
import com.cred0.picturebackend.api.aliyunai.model.AliYunAiApi;
import com.cred0.picturebackend.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.cred0.picturebackend.manager.CosManager;
import com.cred0.picturebackend.manager.upload.FilePictureUpload;
import com.cred0.picturebackend.manager.upload.PictureUploadTemplate;
import com.cred0.picturebackend.manager.upload.UrlPictureUpload;
import com.cred0.picturebackend.model.dto.file.UploadPictureResult;
...
import com.cred0.picturebackend.service.PictureService;
import com.cred0.picturebackend.mapper.PictureMapper;
...
public class PictureServiceImpl extends ServiceImpl<PictureMapper, Picture>
    ...
    public void clearPictureFile(Picture oldPicture) {
        ...
        if (StrUtil.isNotBlank(thumbnailUrl)) {
            cosManager.deleteObject(thumbnailUrl.substring(domain.length()));
        }
    }
